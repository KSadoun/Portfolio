...
(function () {
  ...
  const translations = {
    en: {
      ...
      edu1Heading: "Mechatronics Engineering",
      edu1Meta: '2020 – 2025 ·  Top of class',
      edu1Detail:
    ...
    ar: {
      ...
      edu1Heading: 'هندسة الميكاترونكس',
      edu1Meta: '2020 – 2025 · معدل تراكمي · <span class="align-middle inline-block rounded-full border border-yellow-400 bg-yellow-100 px-2 py-0.5 text-[0.7em] font-bold text-yellow-700 mr-1 rtl:ml-1">#1</span>الأول على الدفعة',
      edu1Detail:
        'تكوين قوي في الميكانيكا والإلكترونيات والبرمجيات مع أساس تحليلي يخدم تطوير التطبيقات المتكاملة.',
      edu2Heading: 'برنامج المعسكر المهني ITI 9 أشهر',
